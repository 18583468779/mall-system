<template>
    <div class="shopcart">
        <div class="addBtn" v-if="bookItem && bookItem.purcharsenum === 0">
            <div class="inner">添加购物车</div>
        </div>

        <div class="shopcart-operate" v-else>
            <span class="shopcart-operate-minus" v-show="bookItem.purcharsenum > 1">-</span>
            <span class="shopcart-operate-del" v-show="bookItem.purcharsenum === 1">
                <i>
                    <svg t="1741008278986" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="1591" width="12" height="12">
                        <path
            ...
            <span class="shopcart-operate-add">+</span>
        </div>
