<template>
    <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-7xl mx-auto grid gap-8 lg:grid-cols-2 lg:max-w-4xl">
            ...
            <div class="relative bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
                <div class="flex flex-col h-full">
                    ...
                    <div class="mt-8">
                        <el-button size="large" class="w-full" :class="{ 'cursor-not-allowed': currentPlan === 'free' }"
                            disabled>
            ...
            <div
                ...
                <div class="flex flex-col h-full">
                    <div class="flex-1">
                        ...
                        <ul class="space-y-3">
                            <li v-for="feature in vipFeatures" :key="feature" class="flex items-start">
                    ...
                    <div class="mt-8">
                        <el-button type="primary" size="large"
                            ...
                            :loading="isPaying" @click="handleUpgrade">
                            {{ currentPlan === 'vip' ? '当前方案' : '立即升级' }}
                        </el-button>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto mt-16">
            <h2 class="text-2xl font-bold text-gray-900 mb-8 text-center">特权对比</h2>
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-4 text-left text-sm font-semibold text-gray-900">会员特权</th>
                            <th class="px-6 py-4 text-center text-sm font-semibold text-gray-900">普通会员</th>
                            <th class="px-6 py-4 text-center text-sm font-semibold text-gray-900">VIP会员</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        <tr v-for="item in compareFeatures" :key="item.feature">
                            <td class="px-6 py-4 text-sm text-gray-700">{{ item.feature }}</td>
